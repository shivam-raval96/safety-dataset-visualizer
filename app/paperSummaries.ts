...
const themes = [
  { match: /causal|contrastive belief|evaluation awareness|prefill awareness|user cues|task cues|prompt ablations|replacement threats/i, summary: "which changes to user cues, tasks, or environments alter model behavior and what those interventions can explain", insight: "Compare matched conditions while varying a specific factor; distinguish a behavioral trigger from evidence of the underlying cause, and check whether the effect survives alternative explanations." },
