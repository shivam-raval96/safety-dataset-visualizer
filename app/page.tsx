...
import { parseCommentsMarkdown } from './comments';
...
export default function Home() {
  ...
  return <AtlasApp datasets={parseDatasets(markdown, embeddings)} history={history} comments={parseCommentsMarkdown(readFileSync(join(process.cwd(), 'data', 'comments.md'), 'utf8'))} />;
}
