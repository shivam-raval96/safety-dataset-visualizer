...
const topics = [
  ...
  { name: "Model forensics", color: "#bd854f", summary: "Controlled changes to inputs, tasks, environments, or model properties to pinpoint when and why models misbehave and investigate the causes of misalignment." },
] as const;
...
const curatedSources: Source[] = [
  ...
  { title: "The Model Organism Lottery", topic: "Model forensics", kind: "Paper", authors: "Szablewski et al.", year: 2026, summary: "Shows that model-organism interpretability depends strongly on training methodology and may be unrealistically easy under post-hoc fine-tuning.", url: "https://arxiv.org/abs/2607.01033" },
