...
const curatedSources: Source[] = [
  { title: "Towards Understanding Sycophancy in Language Models", topic: "Model forensics", kind: "Paper", authors: "Sharma et al.", year: 2023, summary: "Varies the user’s stated preferences and ownership of the same text to isolate how user cues shift model feedback; also tests whether preference optimization favors agreement over truthfulness.", url: "https://arxiv.org/abs/2310.13548" },
  { title: "Language Models Don't Always Say What They Think: Unfaithful Explanations in Chain-of-Thought Prompting", topic: "Model forensics", kind: "Paper", authors: "Turpin et al.", year: 2023, summary: "Changes answer-choice patterns and other biasing task cues while retaining the question, showing that choices can shift toward incorrect answers while reasoning omits the cue and rationalizes the result.", url: "https://arxiv.org/abs/2305.04388" },
  { title: "Alignment Faking in Large Language Models", topic: "Model forensics", kind: "Paper", authors: "Greenblatt et al.", year: 2024, summary: "Varies whether a user is labeled free or paid under a stated training policy, isolating a harmful-compliance gap tied to whether the conversation is said to affect future training.", url: "https://arxiv.org/abs/2412.14093" },
  { title: "Agentic Misalignment: How LLMs Could Be Insider Threats", topic: "Model forensics", kind: "Paper", authors: "Lynch et al.", year: 2025, summary: "Separately varies replacement threats and conflicts between assigned goals and company priorities in simulated environments, finding that either condition can elicit harmful actions such as blackmail or information leaks.", url: "https://arxiv.org/abs/2510.05179" },
  ...
  { title: "Why Do Models Task Game?", topic: "Model forensics", kind: "LessWrong", authors: "Singh, Nanda & Rajamanoharan", year: 2026, summary: "Investigates how beliefs about oversight, grader capability, partial credit, and task completion causally shape task gaming.", url: "https://www.lesswrong.com/posts/HACauvWhEdC6QhdS4/why-do-models-task-game#Discussion" },
  { title: "Decomposing and Measuring Evaluation Awareness", topic: "Model forensics", kind: "Paper", authors: "Li et al.", year: 2026, summary: "Separates evaluation recognizability, model recognition, and behavioral response across nine frontier models and four benchmarks.", url: "https://arxiv.org/abs/2605.23055" },
  ...
  { title: "Prefill Awareness in Large Language Models", topic: "Model forensics", kind: "Paper", authors: "Wang et al.", year: 2026, summary: "Shows frontier models can sometimes recognize edited assistant context, complicating evaluations and control protocols that rely on prefilling.", url: "https://arxiv.org/abs/2606.12747" },
